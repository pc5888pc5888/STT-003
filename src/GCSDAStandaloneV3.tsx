...
import gcsdaLogo0 from "./gcsda-logo-parts/part0";
import gcsdaLogo1 from "./gcsda-logo-parts/part1";
import gcsdaLogo2 from "./gcsda-logo-parts/part2";
...
function Styles(){return <style>{`
  html,body,#root{margin:0;background:#fbfaf7!important;color:#2c271f!important}.g4{--paper:#fbfaf7;--surface:#fffdf9;--soft:#f5efe5;--ink:#2c271f;--muted:#756c60;--gold:#b48a50;--gold2:#835c2e;--line:#ddceb8;min-height:100vh;background:var(--paper);color:var(--ink);font-family:Inter,"Noto Sans TC",system-ui,sans-serif}.g4 *{box-sizing:border-box}.g4-wrap{max-width:1220px;margin:auto;padding:0 30px}.g4-head{position:sticky;top:0;z-index:60;height:84px;background:rgba(255,253,249,.96);border-bottom:1px solid rgba(180,138,80,.24);backdrop-filter:blur(12px)}.g4-headin{height:84px;display:flex;align-items:center}.g4-brand{border:0;background:transparent;padding:0;text-align:left;color:var(--ink);cursor:pointer;text-decoration:none}.g4-brand img{display:block;height:68px;width:auto;max-width:min(430px,34vw);object-fit:contain;object-position:left center}.g4-nav{margin-left:auto;display:flex;align-items:center}.g4-nav a{height:84px;padding:0 11px;display:inline-flex;align-items:center;border:0;background:transparent;color:#655c51;font-size:11px;cursor:pointer;text-decoration:none}.g4-nav a.active{position:relative;color:var(--gold2);background:transparent!important}.g4-nav a.active:after{content:"";position:absolute;left:10px;right:10px;bottom:14px;height:2px;background:var(--gold2)}.g4-join{height:auto!important;margin-left:14px!important;border:1px solid #9b6e38!important;border-radius:999px!important;padding:11px 18px!important;background:#9b6e38!important;color:#fff!important;font-size:13px!important;text-decoration:none!important}.g4-menu{display:none;margin-left:auto;border:0;background:transparent;color:var(--ink);cursor:pointer}
...
.g4-membership-form{margin-top:36px;border-top:1px solid var(--line)}.g4-membership-form label{display:grid;grid-template-columns:220px minmax(0,1fr);gap:28px;padding:22px 0;border-bottom:1px solid var(--line);align-items:start}.g4-membership-form label>span{font:500 15px/1.8 "Noto Serif TC",Georgia,serif;color:var(--gold2)}.g4-membership-form :is(input,select,textarea){width:100%;border:1px solid #d5c5ae;background:#fffdf9;color:var(--ink);padding:12px 14px;font:16px/1.7 "Noto Serif TC",Georgia,serif;outline:none}.g4-membership-form :is(input,select,textarea):focus{border-color:var(--gold2)}.g4-membership-form textarea{resize:vertical}.g4-membership-form button{border:1px solid #9b6e38;background:#9b6e38;color:#fff;padding:12px 20px;border-radius:999px;cursor:pointer}.g4-membership-form button:disabled{opacity:.6;cursor:wait}.g4-honeypot{position:absolute!important;left:-9999px!important;width:1px!important;height:1px!important}.g4-form-status{color:#4f6d42!important}.g4-form-error{color:#8a4f3d!important}.g4-membership-entry{padding-top:72px!important}.g4-membership-flow{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));margin:34px 0 46px;border-top:1px solid var(--line);border-left:1px solid var(--line)}.g4-membership-flow-item{padding:20px 18px;border-right:1px solid var(--line);border-bottom:1px solid var(--line);background:#fffdf9}.g4-membership-flow-item b{display:block;color:var(--gold2);font:500 12px/1.5 Georgia,serif}.g4-membership-flow-item strong{display:block;margin-top:10px;font:500 18px/1.55 "Noto Serif TC",Georgia,serif}.g4-membership-flow-item span{display:block;margin-top:6px;color:var(--muted);font-size:14px;line-height:1.75}
.g4-membership-wizard{margin-top:0!important;border:1px solid var(--line)!important;background:#fffdf9}.g4-form-stepper{display:grid;grid-template-columns:repeat(4,1fr);border-bottom:1px solid var(--line)}.g4-form-step-indicator{display:flex;align-items:center;gap:10px;padding:18px 20px;border-right:1px solid var(--line);color:#81776b}.g4-form-step-indicator:last-child{border-right:0}.g4-form-step-indicator em{display:grid;place-items:center;width:28px;height:28px;border:1px solid #cdbb9e;border-radius:50%;font:500 12px Georgia,serif;font-style:normal}.g4-form-step-indicator span{font:500 14px/1.5 "Noto Serif TC",Georgia,serif}.g4-form-step-indicator.is-active{color:var(--gold2);background:#f8f3ea}.g4-form-step-indicator.is-active em,.g4-form-step-indicator.is-done em{background:#9b6e38;color:#fff;border-color:#9b6e38}.g4-form-panel{padding:34px}.g4-form-panel[hidden]{display:none!important}.g4-form-intro{margin:0 0 28px!important;color:#514a42!important;font-size:16px!important;line-height:1.9!important}.g4-form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:20px}.g4-form-grid label,.g4-form-textarea{display:block!important;padding:0!important;border:0!important}.g4-form-grid label.is-wide{grid-column:1/-1}.g4-form-grid label>span,.g4-form-textarea>span,.g4-form-choice-block legend{display:block;font:500 15px/1.8 "Noto Serif TC",Georgia,serif;color:var(--gold2)}.g4-membership-wizard :is(input[type=text],input[type=tel],input[type=email],input[type=url],select,textarea){margin-top:8px!important;background:#fbfaf7!important}.g4-form-choice-block{border:0;margin:26px 0;padding:0}.g4-choice-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-top:10px}.g4-choice{display:flex!important;align-items:center!important;gap:10px!important;padding:12px 14px!important;border:1px solid #ddd0bc!important;background:#fbfaf7!important}.g4-choice input,.g4-consent input{width:18px!important;height:18px!important;margin:0!important;accent-color:#9b6e38}.g4-choice span{color:#4f493f;font-size:14px}.g4-form-choice-block small{display:block;margin-top:8px;color:#81776b}.g4-form-textarea{margin-top:22px}.g4-form-nav{display:flex;justify-content:space-between;gap:12px;margin-top:30px}.g4-form-nav.is-end{justify-content:flex-end}.g4-form-nav button{border:1px solid #9b6e38;background:#9b6e38;color:#fff;padding:12px 20px;border-radius:999px;cursor:pointer}.g4-form-nav button.is-secondary{background:transparent;color:#805a30}.g4-form-summary{border-top:1px solid var(--line)}.g4-form-summary>div{display:grid;grid-template-columns:150px 1fr;gap:20px;padding:15px 0;border-bottom:1px solid var(--line)}.g4-form-summary span{color:#8a6237}.g4-form-summary strong{font-weight:400;line-height:1.8}.g4-form-notice{margin-top:24px;padding:18px 20px;background:#f8f3ea;border-left:3px solid #9b6e38}.g4-form-notice strong{color:#805a30}.g4-form-notice p{margin:7px 0 0!important}.g4-consent{display:flex!important;grid-template-columns:none!important;gap:12px!important;align-items:flex-start!important;padding:14px 0!important;border:0!important}.g4-consent span{font:400 15px/1.8 "Noto Serif TC",Georgia,serif!important;color:#514a42!important}.g4-privacy-mini{font-size:13px!important;color:#766e64!important}.g4-membership-contact{margin-top:20px}
@media(max-width:760px){.g4-brand img{height:58px;width:auto;max-width:min(270px,66vw);max-height:none}.g4-membership-form label{grid-template-columns:1fr;gap:8px}.g4-form-stepper{grid-template-columns:repeat(2,minmax(0,1fr))}.g4-form-step-indicator{min-width:0;padding:13px 10px}.g4-form-step-indicator:nth-child(2){border-right:0}.g4-form-step-indicator:nth-child(-n+2){border-bottom:1px solid var(--line)}.g4-form-panel{padding:22px 18px}.g4-form-grid,.g4-choice-grid{grid-template-columns:1fr}.g4-form-summary>div{grid-template-columns:1fr;gap:4px}.g4-form-nav{flex-wrap:wrap}.g4-form-nav button{max-width:100%;white-space:normal}.g4-nav a.active:after{display:none}}`}</style>}
...
function Membership(){
  ...
  const [form,setForm]=useState({
    name:"",phone:"",email:"",line_name:"",city:"",
    organization:"",job_title:"",expertise:[] as string[],other_expertise:"",profile_url:"",
    application_source:"",referrer:"",motivation:"",participation_areas:[] as string[],professional_value:"",
    truth:false,privacy:false,"bot-field":""
  });
  ...
  const move=(next:number)=>{
    ...
    if(panel){
      ...
      const invalid=fields.find(field=>field.type!=="checkbox"&&!field.checkValidity());
      if(invalid){invalid.reportValidity();return;}
    }
    if(step===2&&!form.expertise.length){setMessage("請至少選擇一項主要專業領域。");return;}
    if(step===3&&form.motivation.trim().length<50){setMessage("申請加入學會的原因請至少填寫 50 字。");return;}
    setStep(next);
  ...
  const submit=async(event:FormEvent<HTMLFormElement>)=>{
    ...
    setMessage("");
    if(!form.truth||!form.privacy){setStatus("error");setMessage("請確認會員資格治理聲明與個資使用同意。");return;}
    if(!form.expertise.length){setStatus("error");setMessage("請至少選擇一項主要專業領域。");return;}
    setStatus("sending");
    try{
      ...
      setStatus("sent");setMessage("入會申請已送出；送出後進入申請待審狀態，學會將依章程及會務程序進行資料核對與資格審查。");
    }catch{
      setStatus("error");setMessage("目前未完成送出，已填資料仍保留在本頁；請稍後再試，或使用 LINE 會務聯絡入口。");
    }
  };
  const expertiseOptions=["企業經營／策略","公司治理／法遵","法律","會計／財稅","ESG／永續","家族治理／企業接班","金融／資產治理","不動產／建築","科技／AI治理","學術／教育"] as const;
  const participationOptions=["會員大會與專題講座","企業治理與策略交流","家族治理與企業接班","ESG與永續治理","AI治理與數位轉型","出版／研究／專欄協作"] as const;
  const summaryExpertise=[...form.expertise,...(form.other_expertise.trim()?`其他：${form.other_expertise.trim()}`:[])].join("、")||"—";

  return <div className="g4-page">
    <PageHead eyebrow="MEMBERSHIP" title="加入學會，是進入一個以策略、治理、法遵與永續為共同語言的專業共同體。" lead="這是正式的會員資格申請入口；申請人提供基本資料、專業背景與參與意向後，由學會依章程及會務程序進行資格審查。"/>
    <section className="g4-section g4-membership-entry">
      <div className="g4-wrap">
        <div className="g4-kicker">MEMBERSHIP GOVERNANCE ENTRY</div>
        <h2 className="g4-title">申請入會</h2>
        <p className="g4-lead">送出申請不代表立即取得會員資格；資格審查通過後，學會將另行通知後續會費、會員資料建檔及權利義務事項。</p>

        <div className="g4-membership-flow" aria-label="會員加入流程">
          {[
            ["01","提出申請","完成基本資料與參與意向。"],
            ["02","資料核對","秘書處確認聯絡與申請資訊。"],
            ["03","資格審查","依章程與學會治理程序辦理。"],
            ["04","會員生效","審核通知、會費及會員建檔完成後生效。"]
        ...
        <form id="gcsda-membership-form" ref={formRef} className="g4-membership-form g4-membership-wizard" onSubmit={submit} aria-busy={status==="sending"}>
          ...
          <section className="g4-form-panel" data-form-step="1" hidden={step!==1}>
            <p className="g4-form-intro">先建立可被核對的基本聯絡資料；第一階段不蒐集身分證字號等高敏感資料。</p>
            <div className="g4-form-grid">
              <label><span>姓名</span><input required autoComplete="name" value={form.name} onChange={e=>update("name",e.target.value)}/></label>
              <label><span>聯絡電話</span><input required type="tel" autoComplete="tel" inputMode="tel" value={form.phone} onChange={e=>update("phone",e.target.value)}/></label>
              <label><span>電子郵件</span><input required type="email" autoComplete="email" value={form.email} onChange={e=>update("email",e.target.value)}/></label>
              <label><span>LINE 顯示名稱</span><input value={form.line_name} onChange={e=>update("line_name",e.target.value)} placeholder="方便秘書處辨識"/></label>
              <label className="is-wide"><span>所在縣市</span><input value={form.city} onChange={e=>update("city",e.target.value)} placeholder="例如：臺中市"/></label>
            </div>
            <div className="g4-form-nav is-end"><button type="button" onClick={()=>move(2)}>下一步：專業背景</button></div>
          </section>

          <section className="g4-form-panel" data-form-step="2" hidden={step!==2}>
            <p className="g4-form-intro">學會重視專業與治理參與；本頁用來理解申請人的實際背景，不作流量式名單蒐集。</p>
            <div className="g4-form-grid">
              <label><span>現職單位／機構</span><input required value={form.organization} onChange={e=>update("organization",e.target.value)}/></label>
              <label><span>職稱</span><input required value={form.job_title} onChange={e=>update("job_title",e.target.value)}/></label>
            </div>
            <fieldset className="g4-form-choice-block"><legend>主要專業領域</legend><div className="g4-choice-grid">{expertiseOptions.map(option=><label className="g4-choice" key={option}><input type="checkbox" checked={form.expertise.includes(option)} onChange={()=>toggleList("expertise",option)}/><span>{option}</span></label>)}</div><small>至少勾選一項。</small></fieldset>
            <div className="g4-form-grid">
              <label><span>其他專業領域</span><input value={form.other_expertise} onChange={e=>update("other_expertise",e.target.value)}/></label>
              <label><span>公開專業連結</span><input type="url" value={form.profile_url} onChange={e=>update("profile_url",e.target.value)} placeholder="公司官網、LinkedIn 或公開介紹頁"/></label>
            </div>
            <div className="g4-form-nav"><button className="is-secondary" type="button" onClick={()=>setStep(1)}>返回</button><button type="button" onClick={()=>move(3)}>下一步：參與申請</button></div>
          </section>

          <section className="g4-form-panel" data-form-step="3" hidden={step!==3}>
            <p className="g4-form-intro">請簡要說明為何希望加入，以及期待建立何種長期參與關係。</p>
            <div className="g4-form-grid">
              <label><span>申請來源</span><select required value={form.application_source} onChange={e=>update("application_source",e.target.value)}><option value="">請選擇</option><option>自主申請</option><option>現任會員推薦</option><option>學會邀請</option><option>活動／講座後申請</option></select></label>
              <label><span>推薦人／邀請人</span><input value={form.referrer} onChange={e=>update("referrer",e.target.value)} placeholder="如無可留白"/></label>
              <label className="is-wide"><span>申請加入學會的原因</span><textarea required minLength={50} maxLength={300} rows={5} value={form.motivation} onChange={e=>update("motivation",e.target.value)} placeholder="請以 50～300 字說明您的專業背景、加入動機或希望參與的治理議題。"/></label>
            </div>
            <fieldset className="g4-form-choice-block"><legend>希望參與的方向</legend><div className="g4-choice-grid">{participationOptions.map(option=><label className="g4-choice" key={option}><input type="checkbox" checked={form.participation_areas.includes(option)} onChange={()=>toggleList("participation_areas",option)}/><span>{option}</span></label>)}</div></fieldset>
            <label className="g4-form-textarea"><span>您可以帶入學會的專業價值</span><textarea rows={4} value={form.professional_value} onChange={e=>update("professional_value",e.target.value)} placeholder="例如：法律、財稅、企業經營、產業資源、研究、講座或治理實務經驗。"/></label>
            <div className="g4-form-nav"><button className="is-secondary" type="button" onClick={()=>setStep(2)}>返回</button><button type="button" onClick={()=>move(4)}>下一步：確認資料</button></div>
          </section>

          <section className="g4-form-panel" data-form-step="4" hidden={step!==4}>
            <p className="g4-form-intro">請確認以下資料；送出後進入「申請待審」狀態，不會直接顯示為正式會員。</p>
            <div className="g4-form-summary">
              <div><span>姓名</span><strong>{form.name||"—"}</strong></div>
              <div><span>電話</span><strong>{form.phone||"—"}</strong></div>
              <div><span>Email</span><strong>{form.email||"—"}</strong></div>
              <div><span>單位／職稱</span><strong>{form.organization||"—"}／{form.job_title||"—"}</strong></div>
              <div><span>專業領域</span><strong>{summaryExpertise}</strong></div>
              <div><span>加入方式</span><strong>{form.application_source||"—"}{form.referrer?`／${form.referrer}`:""}</strong></div>
              <div><span>申請動機</span><strong>{form.motivation||"—"}</strong></div>
            </div>
            <div className="g4-form-notice"><strong>會員資格治理聲明</strong><p>本表為會員資格申請，不是即時加入；申請人送出資料後，由學會進行資料核對與資格審查，審核通過後才進入會費與正式會員建檔程序。</p></div>
            <label className="g4-consent"><input type="checkbox" checked={form.truth} onChange={e=>update("truth",e.target.checked)}/><span>我確認以上資料真實，並理解送出本表不等於取得會員資格。</span></label>
            <label className="g4-consent"><input type="checkbox" checked={form.privacy} onChange={e=>update("privacy",e.target.checked)}/><span>我同意學會於會員資格審查、聯繫、會務管理與必要行政作業範圍內蒐集、處理及利用本表所提供的資料。</span></label>
            <p className="g4-privacy-mini">本頁不要求身分證字號、金融資料或其他非必要高敏感資料；如審核通過後依法或依章程需要補充資料，將由秘書處另行通知。</p>
            <input className="g4-honeypot" tabIndex={-1} aria-hidden="true" autoComplete="off" value={form["bot-field"]} onChange={e=>update("bot-field",e.target.value)}/>
            <div className="g4-form-nav"><button className="is-secondary" type="button" onClick={()=>setStep(3)}>返回修改</button><button type="submit" disabled={status==="sending"}>{status==="sending"?"正在送出…":"送出會員資格申請"}</button></div>
          </section>
    ...
    <section className="g4-section soft"><div className="g4-wrap"><div className="g4-kicker">MEMBERSHIP FRAMEWORK</div><h2 className="g4-title">會員制度</h2><div className="g4-grid">{[["個人會員","年滿二十五歲、贊同宗旨，依章程完成申請與審查。","入會費 NT$2,000｜常年會費 NT$2,000"],["榮譽會員","由學會依章程與正式程序邀請之公私立機構、團體或個人。","資格與權利義務以章程為準"],["贊助會員","贊同宗旨且對學會無償捐贈之個人、機構或團體。","資格與權利義務以章程為準"]].map((x,i)=><div className="g4-card" key={x[0]}><span>0{i+1}</span><h3>{x[0]}</h3><p>{x[1]}</p><p style={{color:"#835c2e"}}>{x[2]}</p></div>)}</div></div></section>
  </div>;
}
