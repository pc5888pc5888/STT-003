...
function Events(){return <div className="g4-page"><PageHead eyebrow="ASSEMBLY & PROGRAMS" title="活動不是一次性聚會，而是學會制度運作與知識累積的正式紀錄。" lead="會員大會、理監事會、專題講座與正式交流，依可核對之會務資料建立活動檔案；沒有正式資料的活動不預先虛構。"/><section className="g4-section"><div className="g4-wrap"><div className="g4-kicker">ASSEMBLY ARCHIVE</div><h2 className="g4-title">正式活動紀錄</h2><div className="g4-event"><time>2026.08.16</time><div><h3>第一屆第二次會員大會暨第三次理監事聯席會議</h3><p>地點｜沐青餐廳。正式簡報記載本次大會由副理事長范英峰主持；活動結合理監事聯席會議、會員交流、專題講座與餐敘。</p></div><span className="g4-badge">FORMAL ASSEMBLY</span></div><div className="g4-note"><h3>活動檔案原則</h3><p>正式活動紀錄保留日期、活動名稱、性質與可公開之正式資料；不以未核對的成果數字、合作名單或媒體曝光作為裝飾。</p></div></div></section></div>}

function Knowledge(){return <div className="g4-page"><PageHead eyebrow="KNOWLEDGE & RESEARCH" title="讓活動與交流沉澱為可以再次學習、引用與傳承的治理知識。" lead="本頁作為學會知識資產入口，依可公開資料整理企業策略、公司治理、法遵、風險控管與永續相關之研究、講座與治理內容。"/><section className="g4-section"><div className="g4-wrap"><div className="g4-grid">{[["01","企業策略","聚焦企業方向、資源配置、決策結構與策略實務。"],["02","治理與法遵","聚焦公司治理、權責、風險控管、法遵精神與制度運作。"],["03","永續與跨域","聚焦企業永續、跨專業交流及可被組織承接的長期治理知識。"]].map(x=><div className="g4-card" key={x[0]}><span>{x[0]}</span><h3>{x[1]}</h3><p>{x[2]}</p></div>)}</div><div className="g4-note"><h3>知識紀錄原則</h3><p>研究、出版與可公開文件均以已完成且可核對之資料為準，不以虛構篇數、合作機構、研究計畫或影響力數字替代實際成果。</p></div></div></section></div>}
