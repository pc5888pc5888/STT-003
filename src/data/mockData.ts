...
export const articles: Article[] = [
  {
    id: "a_new_col_0a",
    title: "血緣不再是遺產的強制分配器",
    excerpt: "民法繼承編修正草案的制度本質：從強制血緣到意志自治的歷史性轉向，深度解析台灣繼承制度的根本性變革。",
    content: "莊鈞翔博士指出，民法繼承編修正草案標誌著台灣繼承法制從「血緣強制主義」走向「意志自治主義」的歷史性轉折。特留份制度的鬆動，讓遺囑人得以更完整地表達財產分配意志；然而制度鬆綁之際，企業主更須以更嚴謹的法律架構——信託、閉鎖性公司、家族憲章——來填補舊有血緣保障撤退後的治理真空，否則意志自治將淪為紛爭的溫床。",
    date: "2026-06-05",
    category: "資產傳承與家族治理",
    author: "莊鈞翔博士",
    image: "https://picsum.photos/seed/inheritance-reform/1200/800",
    url: "https://94m.com.tw/articles/8b499b?from_admin=true"
  },
  {
    id: "a_new_col_0b",
    title: "遺囑有了，財產還是過不了戶",
    excerpt: "遺囑執行人的四大絕對職權與企業主的稅務流動性危機全解析，揭示遺囑執行實務中最致命的法律陷阱。",
    content: "莊鈞翔博士強調，許多企業主誤以為立好遺囑即萬事大吉，卻忽略了遺囑執行人的法定職權與稅務流動性危機。遺囑執行人依法享有管理遺產、清償債務、移轉財產等四大絕對職權，但若企業資產集中於股權或不動產，流動性不足時遺產稅的繳納壓力將使繼承陷入危機。建立涵蓋保險金信託與預備現金池的稅務緩衝設計，是每一位高資產企業主不可迴避的制度配置。",
    date: "2026-06-04",
    category: "資產傳承與家族治理",
    author: "莊鈞翔博士",
    image: "https://picsum.photos/seed/will-executor/1200/800",
    url: "https://94m.com.tw/articles/c3427a?from_admin=true"
  },
  {
    id: "a_new_col_0c",
    title: "照顧的代價，法律終於開始計算",
    excerpt: "特別貢獻定價、遺產酌給與合法收養：實質付出者的三層救濟戰略，為長期照顧者的法律權益建立完整防護架構。",
    content: "莊鈞翔博士指出，台灣繼承法制長期忽視實質照顧貢獻的法律定價，導致盡心奉養卻在繼承中一無所獲的人倫悲劇不斷上演。修正草案引入「特別貢獻分」機制，讓照顧者得以主張具體補償；搭配遺產酌給請求權與合法收養的身份取得路徑，實質付出者的三層救濟戰略至此形成完整閉環。企業主在規劃傳承架構時，應將照顧貢獻的法律定價納入家族協議的核心條款，以制度彌合情感，以文字固化信任。",
    date: "2026-06-03",
    category: "資產傳承與家族治理",
    author: "莊鈞翔博士",
    image: "https://picsum.photos/seed/care-contribution-law/1200/800",
    url: "https://94m.com.tw/articles/483662?from_admin=true"
  },
  {
    id: "a_new_col_1",
