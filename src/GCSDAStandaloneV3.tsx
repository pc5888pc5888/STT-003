...
@media(max-width:760px){.g4-brand img{width:min(270px,66vw);max-height:60px}.g4-membership-form label{grid-template-columns:1fr;gap:8px}.g4-nav a.active:after{display:none}}`}</style>}
