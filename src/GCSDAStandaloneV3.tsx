...
const GCSDA_HEADER_LOGO_DATA = "/images/gcsda-logo.png";
...
@media(max-width:760px){.g4-brand img{width:min(270px,66vw);max-height:60px}.g4-membership-form label{grid-template-columns:1fr;gap:8px}.g4-form-stepper{grid-template-columns:repeat(2,minmax(0,1fr))}.g4-form-step-indicator{min-width:0;padding:13px 10px}.g4-form-step-indicator:nth-child(2){border-right:0}.g4-form-step-indicator:nth-child(-n+2){border-bottom:1px solid var(--line)}.g4-form-panel{padding:22px 18px}.g4-form-grid,.g4-choice-grid{grid-template-columns:1fr}.g4-form-summary>div{grid-template-columns:1fr;gap:4px}.g4-form-nav{flex-wrap:wrap}.g4-form-nav button{max-width:100%;white-space:normal}.g4-nav a.active:after{display:none}}`}</style>}
