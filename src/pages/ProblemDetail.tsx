...
const data: Record<string, ProblemConfig> = {
  "major-decision": {
    ...
    titleLines: ["重大決策，", "不是先選 A、B、C；而是先確認這是不是正確的問題。"],
  ...
  "owner-dependence": {
    ...
    titleLines: ["公司愈大，", "卻還是只有老闆能決定，真正的風險是組織沒有承接能力。"],
  ...
  "family-ownership": {
    ...
    titleLines: ["家族有資產，", "不代表家族已經知道怎麼共同決定。"],
  ...
  "system-failure": {
    ...
    titleLines: ["有 SOP，", "不等於制度真的會在壓力下運作。"],
  ...
  "founder-legacy": {
    ...
    titleLines: ["人離開以後，", "很多最重要的事情就再也問不到了。"],
...
export default function ProblemDetail(){
  ...
  useEffect(() => {
    if (!cfg) return;
    document.title = `${cfg.title}｜STT Governance`;
